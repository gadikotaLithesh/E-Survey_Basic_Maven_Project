						...
						<form method="post" action="register" class="register-form"
							...
							<div class="form-group">
								<input type="checkbox" name="agree-term" id="agree-term"
									class="agree-term" requried ="required" /> <label for="agree-term"
...
if(status=="success"){
	swal("Congrates","Account Created Sucessfully","success");
}
if(status=="invalidName"){
	swal("Sorry","Please Enter Name","error");
}
if(status=="invalidEmail"){
	swal("Sorry","Please valid Email","error");
}
if(status=="invalidUpwd"){
	swal("Sorry","Please Enter Password","error");
}
if(status=="invalidConfirmPassword"){
	swal("Sorry","Password Doesnt Match","error");
}
